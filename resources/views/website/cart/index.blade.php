                ...
                @foreach($cart_products as $cart_product)
                    <div class="cart-single-list">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-2 col-md-2 col-12">
                                <form action="{{route('update-cart-product' , ['id'=>$cart_product->__raw_id])}}"
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" value="{{$cart_product->qty}}" name="qty" min="1"
                                               required>
                            ...
                            <div class="col-lg-1 col-md-2 col-12">
                                <a class="remove-item"
                                   href="{{route('remove-cart-product',['id'=>$cart_product->__raw_id])}}"
                                   onclick="return confirm('Remove this item?')"><i
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        ...
                                        <li>Tax(5%)<span>Tk. {{$tax = round(($sum * 5) / 100)}}</span></li>
